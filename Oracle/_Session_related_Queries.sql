MOSTRA SQL EXECUTANDO:

select sess.sid,
sql_text
from v$sqltext sqltext, v$session sess
where sess.sql_hash_value = sqltext.hash_value
and sess.sql_address = sqltext.address
...
SELECT s.module,t.inst_id,s.username, s.sid, s.serial#,t.sql_id,t.sql_text "Last SQL"
