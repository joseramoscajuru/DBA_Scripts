...
> tentar entrar na mquina, dar ping se possvel e ligar para a loja e ver se tem internet e se a mquina foi desligada.
> ' uptime '	( mostra o tempo que a mquina est up)
> ' who -b ' 		( mostra qdo foi dado o ltimo reboot na mquina)

===============================================================================================
	- CPU 100%  :  Saber o porque que est alto.

> ' topas ' 	( ver IDLE se est baixo) 
...
> ' smit jfs2'  ou 'jfs'	( programa para aumentar)
> 
...
> errpt more
> ls dev		( quando a fibra estiver com problema, nao se preocupar)
...
## Aumento de file system - Linux Rehhat
	...
	- lvextend -L +tamanhoM lv ( Exemplo - lvextend -L +200M /dev/nwsbrvg/nwsbrlv )
...
* COMANDOS UNIX ** COMANDOS UNIX ** COMANDOS UNIX ** COMANDOS UNIX ** COMANDOS UNIX *
...
## AMBEV ## AMBEV ## AMBEV ## AMBEV ## AMBEV ## AMBEV ## AMBEV ## AMBEV ## AMBEV ## AMBEV ##
