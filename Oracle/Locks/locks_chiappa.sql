SET ECHO off
REM NAME: TFSCLOCK.SQL (metalink)
...
SELECT s.sid, s.serial#, oracle_username USERNAME, owner OBJECT_OWNER,
object_name, object_type, s.osuser, v.process,
DECODE(l.block,
0, 'Not Blocking',
1, 'Blocking',
2, 'Global') STATUS,
...
REM +----------------------------------------------------------+
REM | FILE : all_dml_ddl_locks.sql |
REM | PURPOSE : Query all DML and DDL locks in the database. This |
REM | script will query critical information about the lock |
REM | including Lock Type, Object Name/Owner, OS/Oracle |
REM | User and Wait time (in minutes). |
REM +----------------------------------------------------------+
...
COLUMN WaitMin FORMAT 999G999 HEADING 'Wait Time|(minutes)'
SELECT
